					...
					<div class="col-xl-12">
                        ...
                        <form method="post" action="/store_pegawai">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="no_pegawai" id="no_pegawai" required class="form-control" value="{{ old('no_pegawai') }}">
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="jabatan" required class="form-control" id="jabatan" value="{{ old('jabatan') }}">
                        </div>
                        <div class="mb-3">
